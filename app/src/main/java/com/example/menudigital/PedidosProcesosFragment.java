 ...
 */
public class PedidosProcesosFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener  {
    RecyclerView myrv;
   ...
   // Bundle bundle;
    ...
    public PedidosProcesosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_pedidos_procesos, container, false);
