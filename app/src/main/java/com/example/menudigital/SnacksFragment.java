 ...
 */
public class SnacksFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    RecyclerView myrv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        myrv = rootView.findViewById(R.id.recyclerview_id3);
    ...
    private void cargarWebService() {
        ...
        String urlimg = "http://"+getResources().getString(R.string.ip)+"/bdSistemaPOS/wsJSONConsultarListaSnackUrl.php";
