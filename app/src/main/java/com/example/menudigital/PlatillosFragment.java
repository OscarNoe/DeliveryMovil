 ...
 */
public class PlatillosFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    RecyclerView myrv;
    ...
    private void cargarWebService() {
        ...
        progress.setMessage("Buscando los platillos...");
        progress.show();

        String urlimg = "http://"+getResources().getString(R.string.ip)+"/bdSistemaPOS/wsJSONConsultarListaPlatillosUrl.php";
